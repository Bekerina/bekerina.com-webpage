...
<body>
	...
	<header>
		<div class="container-nav">
			<a href="../../my_web_page/public/design_projects.php#photo-of-design-2"><i class="fas fa-long-arrow-alt-left"></i></a>
		</div>
	</header>
	<section>
		<div class="container"><img alt="Poster - PATINGĖK" src="../app/images/2_poster_patingek_susisiekimo_paslaugos_1.jpg" title="Poster - PATINGĖK"></div>
		<div class="container"><img alt="Details" src="../app/images/2_poster_patingek_susisiekimo_paslaugos_2.jpg" title="Details"></div>
		<div class="container"><img alt="Bus stop" src="../app/images/2_poster_patingek_susisiekimo_paslaugos_3.jpg" title="Bus stop"></div>
		<div class="container"><img alt="Clear channel" src="../app/images/2_poster_patingek_susisiekimo_paslaugos_4.jpg" title="Clear channel"></div>
    </section>
