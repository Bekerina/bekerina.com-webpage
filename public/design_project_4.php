...
<head>
    ...
    <title>BRANDBOOK || Northway</title>
...
<body>
    ...
    <!--END smooth page transition-->
		...
		<div class="container-nav">
			<a href="../../my_web_page/public/design_projects.php#photo-of-design-4"><i class="fas fa-long-arrow-alt-left"></i></a>
		</div>
	</header>
	<section>
		<div class="container"><img alt="Tablet" src="../app/images/4_brandbook_nmc_1.jpg" title="Tablet"></div>
		<div class="container"><img alt="Business card design" src="../app/images/4_brandbook_nmc_2.jpg" title="Business card design"></div>
		<div class="container"><img alt="Blank design" src="../app/images/4_brandbook_nmc_3.jpg" title="Blank design"></div>
		<div class="container"><img alt="Colors" src="../app/images/4_brandbook_nmc_4.jpg" title="Colors"></div>
		<div class="container"><img alt="Outdoor" src="../app/images/4_brandbook_nmc_5.jpg" title="Outdoor"></div>
	</section>
