...
<body>
	...
	<header>
		<div class="container-nav">
			<a href="../../my_web_page/public/design_projects.php#photo-of-design-5"><i class="fas fa-long-arrow-alt-left"></i></a>
		</div>
	</header>
	<section id="vilma-page">
		<div class="container"><img alt="Webpage design" src="../app/images/5_vilma_webpage_1.jpg" title="Webpage design"></div>
		<div class="container"><img alt="Webpage design" src="../app/images/5_vilma_webpage_2.jpg" title="Webpage design"></div>
	<div class="vilma-web">
		<a href="https://vilmaelectric.lt/" target="_blank">vilmaelectric.lt</a>
	</div>
	</section>
